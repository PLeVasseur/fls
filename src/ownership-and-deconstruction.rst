...
:dp:`fls_c02flohk54pc`
:dt:`Borrowing` is the process of temporarily associating a :t:`reference` with a
...
:dp:`fls_MT69AGRXH9pS``
An :t:`implicit borrow` may be an :dt:`immutable borrow` or a :t:`mutable borrow`
if required.
...
* :dp:`fls_W2S2FrkuedYC`
  ...
  :dt:`pattern-without-alternation`.
