...
- `Stabilize if let guards on match arms <https://github.com/rust-lang/rust/pull/141295>`_
  ...
  FLS models the Rust 2021 stable syntax accepted by :c:`rustc` 1.95.0. It
  does not add the Rust Reference's guard-let attribute position because
  attributes on expressions remain unstable in this context.
